...
static const char *fonts[]          = { "JetbrainsMono nerd font:size=11", "JoyPixels:size=10" };
...
static const char col_gray3[]       = "#f2eeed"/* "#585764"*/;
...
static const char col_yellow[]      = "#181825";
static const char col_pink[]        = "#d5aeea";
...
static const Rule rules[] = {
  ...
  { "Discord",  "discord",  "Discord",  1 << 4,       0,            0 },
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray2, "-nf", col_gray3, "-sb", col_pink, "-sf", col_gray4, NULL };
